              ...
              return (
                ...
                >
                  ...
                  {isRevealed && isCorrect && (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="ml-2 text-emerald-600 inline-block">
                      <polyline points="20 6 9 17 4 12" />
                    </svg>
                  )}
                  {isRevealed && isSelected && !isCorrect && (
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="ml-2 text-red-600 inline-block">
